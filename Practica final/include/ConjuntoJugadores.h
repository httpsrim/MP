...
public:
   ...
   /**
    * @brief Devuelve el numero de jugadores
    * @return numjugadores
    */
    int numerojugadores(int newjug);
    /**
     ...
     */
    friend std::ostream & operator<< (std::ostream & flujo, const ConjuntoJugadores & conjug);    
    ...
    /**
     * @brief actualiza la información del campeonato con los resultados de una partida recien realizada.
     * @param jug1 id del jugador ganador.
     * @param jug2 id del otro jugador.
     */
    void apuntaPartida(int jug1,int jug2);
    /**
     * @brief matriz con los datos de la competicion.
     * @return devuelve un string con la información de la variable competicion.
     */
    string esquemaCompeticion();
/**
 * @brief Salva en un archivo
 * @param fichero
 */
    void save(string fichero);
   /**
    * @brief Carga archivo
    * @param fichero
    */
    void load(string fichero);
     ...
     void jugadores(string * nombre,string * apellids, int numjug);
private: 
    /**
    ...
    /*partidas ganadas por 2 jugadores*/
    int partidasganadas[10][10];  //10 es el tam max.
};
